 ...
 */
public class KeyIndexLineChart extends View {
    ...
    public KeyIndexLineChart(Context context) {
        this(context, null);
    }
public void setDateSource(keyIndexLinebean keyIndexLinebean){
    ...
    public KeyIndexLineChart(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public KeyIndexLineChart(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        /**画X轴的刻度*/
        xandyPaint.setTextSize(height / 3);
        ...
        for (int i=0;i<keyIndexLinebean.getX_numbers().size();i++){
            canvas.drawText(keyIndexLinebean.getX_numbers().get(i),width+i*average_x,height*7+height/4*3,xandyPaint);
        }
            }
        /**画Y轴的刻度*/
        xandyPaint.setTextSize(height / 3);
